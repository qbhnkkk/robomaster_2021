...
public:
    ...
    int brightness_threshold_blue = 48;
    int brightness_threshold_red = 48;
    int brightness_threshold_m = 255;
    //int color_threshold_v = 100;
    int color_threshold_blue = 33;
    int color_threshold_red = 33;
...
public:
    ...
    //自瞄任务
    int ArmorDetectTask(Mat& frame, OtherParam other_param);
...
private:
    ...
    float add_angle_x(bool is_right,bool is_left,double lv,double av,OtherParam other_param);
    double l_v;
    float a_v;
    double l_a;
    bool angle_left;
